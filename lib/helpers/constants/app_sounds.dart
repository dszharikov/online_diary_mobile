...
class AppSounds {
  ...
  static const String reactionBoxClosed =
      'assets/sounds/reaction_box_closed.mp3';

  /// The path for reaction button short tap sound asset
  static const String reactionButtonTap =
      'assets/sounds/reaction_button_short_tap.mp3';
